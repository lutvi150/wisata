  ...
  <body>
    ...
    <div class="slider-wrap">
      <section class="home-slider owl-carousel">
        ...
        <div class="slider-item" style="background-image: url('<?=base_url()?>/assets/img/kubu_gadang/1675667748065.jpg');">
          
          <div class="container">
            <div class="row slider-text align-items-center justify-content-center">
              <div class="col-md-8 text-center col-sm-12 ">
                <h1 data-aos="fade-up">Nikmati liburan mu</h1>
                <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Nikmati liburan yang asri dan nyaman dengan suasana desa khas Minang</p>
                <p data-aos="fade-up" data-aos-delay="200"><a href="#" class="btn btn-white btn-outline-white">Order</a></p>
              </div>
            </div>
          </div>
        ...
        <div class="slider-item" style="background-image: url('<?=base_url()?>/assets/img/kubu_gadang/1675667748082.jpg');">
          <div class="container">
            <div class="row slider-text align-items-center justify-content-center">
              <div class="col-md-8 text-center col-sm-12 ">
                <h1 data-aos="fade-up">Habiskan liburan mu disini</h1>
                <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Bingung mau liburan dimana, ke Desa Kubu Gadang dan nikmati semua paket wisata yang ada</p>
                <p data-aos="fade-up" data-aos-delay="200"><a href="#" class="btn btn-white btn-outline-white">Order</a></p>
              </div>
            </div>
          </div>
    ...
    <section class="section pb-0">
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-lg-4">
            <img src="<?=base_url();?>assets/img/kubu_gadang/1675667748288.jpg" alt="Image" class="img-fluid about_img_1" data-aos="fade" data-aos-delay="200">
          </div>
          <div class="col-lg-4">
            <img src="<?=base_url();?>assets/img/kubu_gadang/1675667748239.jpg" alt="Image" class="img-fluid about_img_1" data-aos="fade" data-aos-delay="300">
            <img src="<?=base_url();?>assets/img/kubu_gadang/1675667748073.jpg" alt="Image" class="img-fluid about_img_1" data-aos="fade" data-aos-delay="400">
          </div>
          <div class="col-lg-4">
            <img src="<?=base_url();?>assets/img/kubu_gadang/1675667748097.jpg" alt="Image" class="img-fluid about_img_1" data-aos="fade" data-aos-delay="500">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="clearfix mb-5 pb-5">
        ...
        <div class="owl-carousel centernonloop">
          <a href="#" class="item-dishes" data-aos="fade-right" data-aos-delay="100">
            ...
            <img src="<?=base_url();?>assets/front/img/dishes_1.jpg" alt="" class="img-fluid">
          </a>
          <a href="#" class="item-dishes" data-aos="fade-right" data-aos-delay="200">
            ...
            <img src="<?=base_url();?>assets/front/img/dishes_2.jpg" alt="" class="img-fluid">
          </a>
          <a href="#" class="item-dishes" data-aos="fade-right" data-aos-delay="300">
            ...
            <img src="<?=base_url();?>assets/front/img/dishes_3.jpg" alt="" class="img-fluid">
          </a>
          <a href="#" class="item-dishes" data-aos="fade-right" data-aos-delay="400">
            ...
            <img src="<?=base_url();?>assets/front/img/dishes_4.jpg" alt="" class="img-fluid">
          </a>
        </div>
      </div>
        ...
        <div class="row no-gutters">
          <div class="col-md-6">
            <div class="sched d-block d-lg-flex">
              <div class="bg-image order-2" style="background-image: url('<?=base_url()?>/assets/front/img/dishes_4.jpg');" data-aos="fade"></div>
            ...
            <div class="sched d-block d-lg-flex">
              <div class="bg-image" style="background-image: url('<?=base_url()?>/assets/front/img/dishes_1.jpg');" data-aos="fade"></div>
              <div class="text">
        ...
        <div class="row">
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="blog d-block">
              <a class="bg-image d-block" href="single.html" style="background-image: url('<?=base_url()?>/assets/front/img/dishes_1.jpg');"></a>
              <div class="text">
          ...
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="blog d-block">
              <a class="bg-image d-block" href="single.html" style="background-image: url('<?=base_url()?>/assets/front/img/dishes_2.jpg');"></a>
              <div class="text">
                <h3><a href="single.html">How To Cook Pasta?</a></h3>
                <p class="sched-time">
                  <span><span class="fa fa-calendar"></span> April 22, 2018</span> <br>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-4 mb-5">
            <h3>Tentang Kami</h3>
            <p class="mb-5">Kubu Gadang merupakan salah satu desa wisata di Provinsi Sumatera Barat. Terletak di kota Padang Panjang, Sumatera Barat</p>
            ...
            <div>
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block">
                  ...
                  <span>Jl. H. Miskin, Ekor Lubuk, Kec. Padang Panjang Tim., Kota Padang Panjang, Sumatera Barat 27122</span></li>
                <li class="d-block"><span class="d-block text-black">No.Hp:</span><span>0852-6380-9321</span></li>
                <li class="d-block"><span class="d-block text-black">Email:</span><span>kubugadang@kubugadang.id</span></li>
              </ul>
            </div>
          </div>
          <div class="col-md-3">
        ...
        <div class="row">
          <div class="col-12 text-md-center text-left">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart text-danger" aria-hidden="true"></i> by <a href="#" target="_blank" ><?=$this->config->item('app_name')?></a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
        </div>
...
<!-- Modal -->
<div class="modal fade" id="map-confirm" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				Selamat Datang di website Desa Wisata Kubu Gadang, apakah anda ingin di arahkan ke lokasi, kalau iya sistem kami akan membuka map untuk anda 
			</div>
