	...
	<section class="section">
		<div class="section-header">
			...
			<div class="section-header-breadcrumb">
				...
				<div class="breadcrumb-item">Edit Paket Wisata</div>
			</div>
		</div>

		<div class="section-body">
			<h2 class="section-title">Edit Paket Wisata</h2>
			<p class="section-lead">Gunakan menu dibawah untuk mengubah paket wisata</p>
			...
			<div class="row">
				<div class="col-12 col-md-12 col-lg-12">
					<div class="card">
						...
						<form action="<?=base_url('admin/update_paket_wisata/update')?>" id="store-produk" method="post">
							<div class="card-body row">
								<div class="col-12 col-md-6 col-lg-6">
									...
									<div class="form-group row mb-12">
										...
										<div class="col-sm-12 col-md-9">
											<input type="text" name="harga" value="<?=$paket->harga_paket?>"   class="form-control">
									...
									<div class="form-group row mb-12">
										...
										<div class="col-sm-12 col-md-9">
											<select name="satuan" class="form-control" id="satuan">
												<option <?=$paket->satuan == 1 ? "selected" : ""?> value="1">Per Orang</option>
												<option <?=$paket->satuan == 2 ? "selected" : ""?> value="2">Per Kelompok</option>
												<option <?=$paket->satuan == 2 ? "selected" : ""?> value="3">Per Pax</option>
											</select>
									...
									<div class="form-group row mb-12">
										...
										<div class="col-sm-12 col-md-9">
											<textarea name="keterangan" class="summernote-simple"><?=$paket->keterangan?></textarea>
								...
								<div class="col-12 col-md-6 col-lg-6">
									...
									<div class="form-group row mb-12">
										...
										<div class="col-sm-12 col-md-9">
											<input type="text" name="lat" value="<?=$paket->lat?>" class="form-control">
									...
									<div class="form-group row mb-12">
										...
										<div class="col-sm-12 col-md-9">
											<input type="text" name="long" value="<?=$paket->long?>" class="form-control">
